...
// Calculation constants and pure calculation functions (calculateCore, calculateProductValue,
// analyzeWishlist, BRANDS/lookupBrand, etc.) now live in calculations.js, loaded before this file.
 ...
 * Returns null if data is invalid. Validates here (DOM-dependent), then
 * delegates the actual math to the pure calculateCore() in calculations.js.
 */
function calculate(data) {
  if (!validateForm(data)) return null;
  return calculateCore(data);
}
...
// _siMetrics/_siScore/_siDecision/_siReason/analyzeWishlist now live in calculations.js
...
// BRANDS data + lookupBrand() now live in calculations.js
...
// calculateProductValue() + getProductValueVerdict() now live in calculations.js
